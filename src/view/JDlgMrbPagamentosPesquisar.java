 ...
 * @author PC
 */
public class JDlgMrbPagamentosPesquisar extends javax.swing.JDialog {
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgMrbPagamentosPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgMrbPagamentosPesquisar dialog = new JDlgMrbPagamentosPesquisar(new javax.swing.JFrame(), true);
