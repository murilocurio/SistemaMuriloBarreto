 ...
 * @author PC
 */
public class JDlgMrbClientesPesquisar extends javax.swing.JDialog {
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgMrbClientesPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgMrbClientesPesquisar dialog = new JDlgMrbClientesPesquisar(new javax.swing.JFrame(), true);
