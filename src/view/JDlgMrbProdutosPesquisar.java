 ...
 * @author PC
 */
public class JDlgMrbProdutosPesquisar extends javax.swing.JDialog {
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgMrbProdutosPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgMrbProdutosPesquisar dialog = new JDlgMrbProdutosPesquisar(new javax.swing.JFrame(), true);
